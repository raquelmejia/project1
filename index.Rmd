...
The purpose of this analysis was to examine wealth disparities across the U.S. and how these wealth disparities may influence accessibility to fertility treatments.
<br>
<br>
...
```
<br>
Figure 4 allows for the comparison of a state's average number of treatment cycles and whether or not the state is above or below the median U.S. income of 2019 ($65,712).  

The top map has a threshold colored in white at 526 cycles, which is the average number of treatment cycles for states below the U.S. median income. States in the top map that are red are below this threshold, while states that are green are above this threshold.  
